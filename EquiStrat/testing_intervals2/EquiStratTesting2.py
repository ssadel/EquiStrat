...
class EquiStrat():
    ...
    # --- CHANGE THESE VALUES ---
    fileName = "testing_intervals2/07-15_close.json"
    ...
    spFileName = 'sp500_data/sp500_07-15.csv'
    # --- END CHANGE VALUES ---
    ...
    def __init__(self):
        ...
        if snpPercentChange<0:
            ...
            newEquity = postMarketEquity
            newCash = cash
            newAccountOne = newEquity + newCash
            newAccountTwo = postMarketAccountTwo
            
        elif (snpPercentChange>0) and (postMarketEquity + cash > 1000000):
            #print("2")
    ...
    def transferEquity(self, cash, postEquity, preEquity, accountTwo):
        ...
        #print("account2", accountTwo, "extra", extra, "newaccount2amt", newAccountTwoAmt)
